...
class HospitalFacility extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    return Container(
      margin: EdgeInsets.only(left: 20, top: 20 / 2, bottom: 20 * 0.5),
...
class HealthFacility extends StatelessWidget {
...
class CheckupFacility extends StatelessWidget {
  const CheckupFacility({
    Key? key,
    required this.image,
    required this.press,
    required this.name,
  ...
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    return Container(
      margin: EdgeInsets.only(left: 10, top: 20 / 2, bottom: 20 * 0.5),
